...
class _VolunteerPageState extends State<VolunteerPage> {
  ...
  Future<void> fetchVolunteerDetails() async {
    final Uri url = Uri.https(
        'https://mobile-project2024.000webhostapp.com/fetch_events.php');
  ...
  Future<void> volunteerForEvent(String eventId, String eventName) async {
    final Uri url = Uri.https(
        'https://mobile-project2024.000webhostapp.com/create_volunteer.php');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Show success alert after successful volunteering
        showSuccessAlert();
      } else {
  ...
  void filterSearchResults(String query) {
    ...
    if (query.isNotEmpty) {
      ...
      searchList.forEach((item) {
        if (item['event_name'].toString().toLowerCase().contains(
            query.toLowerCase())) {
          resultList.add(item);
        }
      });
  ...
  Future<void> showVolunteerAlert(String eventId, String eventName) async {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Confirm Volunteering',style: TextStyle(fontWeight: FontWeight.bold),),
          content: Text('Do you want to volunteer for $eventName?',
              style: GoogleFonts.poppins()), // Update text style here
          actions: <Widget>[
            TextButton(
              onPressed: () {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            ...
            style: TextStyle(
              fontFamily: 'Poppins',
              // Assuming 'Poppins' is the font family name for Google Fonts
