...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> signUp(String username, String email, String password, BuildContext context) async {
    final Uri url = Uri.parse('https://mobile-project2024.000webhostapp.com/signup.php'); // Replace with your PHP endpoint
  ...
  void clearTextFields(BuildContext context) {
    ...
    // You might want to navigate or perform other actions here after clearing the fields
  }
      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          focusedBorder: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: Colors.black), // Change the focused border color here
          ),
        ),
      ),
      home: Scaffold(
