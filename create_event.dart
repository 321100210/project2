...
const String _baseURL = 'https://mobile-project2024.000webhostapp.com/create_event.php';

void main() {
  runApp(
    MaterialApp(
      theme: ThemeData(
        textTheme: GoogleFonts.poppinsTextTheme(), // Apply Poppins font to textTheme
      ),
...
class _CreateEventPageState extends State<CreateEventPage> {
  ...
  Future<void> _insertDataToDatabase() async {
    ...
    // Parse and format time in Flutter before sending it
    ...
    print(response.body); // Add this line to print the response body on error
        ...
        return Theme(
          data: ThemeData.dark().copyWith(
            colorScheme: const ColorScheme.dark(
              primary: Colors.white70, // Change grey to white
              onPrimary: Colors.white, // Change grey to white
  ...
  Future<void> _selectTime(
    ...
    final TimeOfDay? picked = await showTimePicker(
      ...
      builder: (BuildContext context, Widget? child) {
        return Theme(
          data: ThemeData.dark().copyWith(
            colorScheme: const ColorScheme.dark(
              primary: Colors.white, // Adjust primary color of the picker
              onPrimary: Colors.white, // Adjust text color on the primary background
              surface: Colors.black, // Adjust background color of the picker
              onSurface: Colors.white, // Adjust text color on the surface (background)
            ),
            dialogBackgroundColor: Colors.black, // Adjust dialog background color
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                primary: Colors.white, // Adjust button text color
              ),
            ),
          ),
          child: child!,
    ...
    if (picked != null) {
      ...
      setState(() {
        controller.text =
            formattedTime; // Set the selected time to the text field
      });
    }
  }
